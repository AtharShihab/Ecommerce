...
using Ordering.Application.Commands.Users.Create;
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            var builder = WebApplication.CreateBuilder(args);
            {
                ...
                string _expirtyMinutes = builder.Configuration["Jwt:ExpiryMinutes"];
                ...
                builder.Services.AddSingleton<ITokenGenerator>(new TokenGenerator(jwtSettings));
                // Dependency injection with key
                //builder.Services.AddSingleton<ITokenGenerator,Tok>(_ => new TokenGenerator(_key, _issuer, _audience, _expirtyMinutes));
